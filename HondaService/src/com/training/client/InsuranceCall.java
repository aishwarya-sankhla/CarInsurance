...
public int callClient(String regno){
	...
	try {
			...
			url = new URL("http://localhost:8080/Insurance/rest/insurance/"+regno);
	    	...
	    	url2 = new URL("http://localhost:8080/Insurance/rest/insurance/rates/"+insuranceDetails.getInsuranceType());
...
public void registerClaim(String regno, String dateOfRequest, String serviceCenter){
	...
	try {
		...
		url = new URL("http://localhost:8080/Insurance/rest/insurance/logClaim");
